...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2020 at 04:20 AM
...
INSERT INTO `cliente` (`IdCliente`, `Nome`, `Sobrenome`, `Cpf`, `IdCidade`, `IdEstado`, `Cep`, `Logradouro`, `Complemento`, `Numero`, `email`, `senha`, `usuario`, `DataNasc`) VALUES
(1, 'Kauã', 'Aquino', '50668182865', 5038, 26, '09381050', 'Rua Rio de Janeiro', 'Casa B ', '967', 'kauamaiaaquino@gmail.com', 'jogos2003', 'kauaaquino', NULL),
(2, 'teste21', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'testenome', 'testesobrenome', 'teste@gmail.com', NULL, NULL, '09381-050', 'Rua Rio de Janeiro', 'portão branco', '312', 'teste@gmail.com', 'teste', 'teste', NULL),
(4, 'nome', 'sobrenome', '666.666.666-66', NULL, NULL, '09381-050', 'Rua Rio de Janeiro', 'portão ice', '967', 'email@email.com', 'senha', 'usuario', NULL),
(5, 'Kauã', 'Aquino', '506.684.694-69', NULL, NULL, '69350-000', '', 'portao tal', '9879', 'teste3@gmail.com', '12345', 'usuario', NULL),
(17, 'eae', 'eae', '412.412.412-41', NULL, 26, '09381-050', 'Rua Rio de Janeiro', 'portão ice3123', '967', 'kauacarretel2003@hotmail.com]412', '412', 'usuario312', NULL),
(18, 'nome', 'sobrenome', '231.231.213-13', 5038, 26, '09381-050', 'Rua Rio de Janeiro', '3123eaw', 'eaes132', 'email@email.com', '1234', 'usuario', NULL),
(19, 'nomekaka', 'sobrenomekaka', '412.412.414-21', 5038, 26, '09381-050', 'Rua Rio de Janeiro', 'testeste', '123', 'ee', 'ea', 'usuario', NULL),
(20, 'testetstes', 'testeste', '666.666.666-63', 5038, 26, '09381-050', 'Rua Rio de Janeiro', 'EAEA', '124', 'ea', 'ea', 'ea', NULL),
(21, 'eae', 'eae', '124.124.214-12', 4718, 22, '69350-000', '', 'eaeae', '233', 'eaea', 'ea', 'eaea', '2003-10-30'),
(22, 'nome', 'sobrenome', '321.431.241-24', 5038, 26, '09381-050', 'Rua Rio de Janeiro', 'Portao 2', '312', 'email@email.com', '123', 'teste123', '2003-10-30'),
(23, 'Kauã ', 'Teste Final', '412.412.412-41', 5038, 26, '09381-050', 'Rua Rio de Janeiro', '', '4', 'kauaplayer22@gmail.com', '123', 'teste1234', '2003-10-30');
...
CREATE TABLE `notafiscal` (
  ...
  `DataNotaFiscal` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `notafiscal` (`IdNotaFiscal`, `valor_total`, `DataNotaFiscal`) VALUES
(1, '1.00', '2020-09-14');
...
INSERT INTO `produtos` (`IdProdutos`, `NomeProduto`, `precounit`) VALUES
(1, 'Ovos Vermelhos', '0.10'),
(45, 'beterraba', '0.90'),
(46, 'limão', '0.30'),
(47, 'melancia', '10.00');
...
--
-- Table structure for table `produtosnf`
--

CREATE TABLE `produtosnf` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `produtosnf`
--

INSERT INTO `produtosnf` (`id`, `idProduto`, `Nf`, `qtde`, `subtotal`) VALUES
(1, 1, 1, 10, '1.00');
...
--
-- Indexes for table `produtosnf`
--
ALTER TABLE `produtosnf`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `notafiscal`
  MODIFY `IdNotaFiscal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `produtos`
--
ALTER TABLE `produtos`
  MODIFY `IdProdutos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `produtosnf`
--
ALTER TABLE `produtosnf`
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_2` FOREIGN KEY (`IdCidade`) REFERENCES `cidades` (`id`),
  ADD CONSTRAINT `cliente_ibfk_3` FOREIGN KEY (`IdEstado`) REFERENCES `estados` (`id`),
  ADD CONSTRAINT `cliente_ibfk_4` FOREIGN KEY (`IdEstado`) REFERENCES `estados` (`id`);

--
-- Constraints for table `produtosnf`
--
ALTER TABLE `produtosnf`
  ADD CONSTRAINT `produtosnf_ibfk_1` FOREIGN KEY (`idProduto`) REFERENCES `produtos` (`IdProdutos`),
  ADD CONSTRAINT `produtosnf_ibfk_2` FOREIGN KEY (`Nf`) REFERENCES `notafiscal` (`IdNotaFiscal`);
COMMIT;
