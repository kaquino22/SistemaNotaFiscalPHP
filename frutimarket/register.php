...
<script>
    $(document).ready(function () {
			...
			if ($('.confirmarSenha').val() == "") {
				$('.ErroSenha').html('<div class="alert alert-danger"><p>Confirme a sua Senha!</p></div>');
